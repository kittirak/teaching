...
3. ในหน้า **"Create a virtual machine"** ให้ตั้งค่าดังนี้:
   ...
   - **Region:** เลือกภูมิภาคที่ใกล้ที่สุด (เช่น **(Asia Pacific) Malaysia West หรือ East Asia**)
...
5. จะมีหน้าต่างให้ดาวน์โหลดไฟล์คีย์ส่วนตัว (`.pem`) **สิ่งสำคัญ:** **ให้บันทึกไฟล์ .pem นี้ไว้ในที่ปลอดภัย** เพราะจะใช้ในการเชื่อมต่อ SSH
